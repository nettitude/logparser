...
SELECT 
     ...
     EXTRACT_TOKEN(AuditData,73,'"') AS EventData,
     EXTRACT_TOKEN(AuditData,77,'"') AS TargetUserOrGroupType,
     EXTRACT_TOKEN(AuditData,81,'"') AS TargetUserOrGroupName
FROM  'C:\AuditLog.csv'
WHERE Operations LIKE 'SharingSet'